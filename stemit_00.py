...
#    @ntrace
    def mdGetWordDict(self):
        ''' Return the dictionary of stems and their words. '''
        return self.dWords
...
def fnvDumpWords(mydWords):
    ...
    print("\n\n====== FINAL DICT ======")
    for sStem, lWords in sorted(mydWords.items()):
        sWords = '  '.join(lWords)
        print("%-30s %s" % (sStem, sWords))
